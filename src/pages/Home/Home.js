            ...
            <div className={'home__firstPage container'}>
                <div className="container">
                    <div className="home__firstPage-wrapper">
                        ...
                        <h2 className={'home__firstPage-title'}>We rethink <span className={'firstPage__title-bot'}>the web</span></h2>
                        <button className={'home__firstPage-btn circleBtn'}>Consultation <span>
                ...
                <div className="container">
                    <div className="home__information-wrapper">
                        ...
                        <div className={'home__information-main'}>
                            <p className={'home__information-text'}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
